...
if [ ${force} -eq 0 ]; then
	...
	CURRENT=`wget -qO - 'https://raw.githubusercontent.com/jericho99/alike/main/host/a3.rev.num'`
...
wget -qO qs.sh 'https://raw.githubusercontent.com/jericho99/alike/main/host/a3_update.sh' && bash qs.sh -quiet $@
if [[ -f qs.sh ]]; then
        rm qs.sh
fi
